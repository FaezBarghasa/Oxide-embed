            ...
            Language::Svd => {
                ...
                for (idx, line) in content.lines().enumerate() {
                    ...
                    if trimmed.starts_with("<peripheral>") || trimmed.contains("<peripheral ") {
                        ...
                        if current_peripheral.is_none()
                            && (trimmed.contains("<name>") || trimmed.starts_with("<name>"))
                        {
                            ...
                            symbols.push(SymbolRecord {
                                ...
                                signature: Some(format!(
                                    "Register {} of {}",
                                    reg_name, periph_name
                                )),
                                doc: None,
                                fingerprint: format!(
                                    "svd_reg:{}:{}:{}",
                                    periph_name, reg_name, line_no
                                ),
                                is_macro_node: false,
                            ...
                            && !trimmed.starts_with("//")
                        {
                            ...
                            if !region_name.is_empty() {
                                symbols.push(SymbolRecord {
                                    ...
                                    summary: Some(format!(
                                        "Memory region {} in linker script",
                                        region_name
                                    )),
                                });
                            }
